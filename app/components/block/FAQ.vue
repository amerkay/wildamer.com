      ...
      <div class="lg:grid lg:grid-cols-12 lg:gap-8">
        <div class="lg:col-span-5">
          ...
          <p class="mt-4 text-base/7 text-pretty text-muted-foreground">
            My mission is to create tech solutions to advance wildlife conservation.
          </p>
        </div>
        <div class="mt-10 lg:col-span-7 lg:mt-0">
          ...
          >
            ...
            >
              <AccordionTrigger
                :class="['text-base/7 font-bold text-foreground', { 'pt-0': idx === 0 }]"
                >{{ faq.question }}</AccordionTrigger
              >
              <AccordionContent class="mt-2 text-base/7">
                <template v-if="faq.type === 'timeline'">
                  <div
                    v-if="faq.parsedParagraphsBefore && faq.parsedParagraphsBefore.length"
                  ...
                  <Timeline
                    :items="faq.content"
                    :class="{
                      'mt-6': faq.parsedParagraphsBefore && faq.parsedParagraphsBefore.length
                    }"
                    class="mb-4"
                  />
                </template>
...
const faqs = [
  {
    ...
    content: [
      ...
      },
      {
        ...
        date: 'Future Phase',
        description: 'Growing it. Offering it to hundreds or thousands of conservation efforts.',
