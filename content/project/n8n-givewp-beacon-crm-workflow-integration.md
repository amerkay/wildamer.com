...
image: /imgs/project-n8n-givewp-beacon-integration-workflow/n8n-workflow-givewp-beacon-cover.png
imageDark: /imgs/project-n8n-givewp-beacon-integration-workflow/n8n-workflow-givewp-beacon-cover-dark.png
...
![GiveWP Donation Fundraising Page](/imgs/project-n8n-givewp-beacon-integration-workflow/givewp-donation-fundraising-page.png)
...
![Overview screenshot of the GiveWP - Beacon CRM n8n integration workflow](/imgs/project-n8n-givewp-beacon-integration-workflow/n8n-workflow-givewp-beacon-overview.png)
...
![n8n Workflow Paths](/imgs/project-n8n-givewp-beacon-integration-workflow/n8n-workflow-givewp-beacon-paths.png)
...
![n8n Upsert Beacon Organisation from GiveWP Donor Company Field](/imgs/project-n8n-givewp-beacon-integration-workflow/n8n-sync-givewp-beacon-company-organisation.png)
...
![n8n Sync Beacon Person from GiveWP Donor Fields](/imgs/project-n8n-givewp-beacon-integration-workflow/n8n-sync-givewp-beacon-person.png)
...
![n8n Sync Beacon Gift Aid Declarations from GiveWP](/imgs/project-n8n-givewp-beacon-integration-workflow/n8n-sync-givewp-beacon-gift-aid-declarations.png)
...
![n8n Sync Beacon - GiveWP Campaign and campaign member](/imgs/project-n8n-givewp-beacon-integration-workflow/n8n-sync-givewp-beacon-campaign-members.png)
...
![n8n Sync Beacon - GiveWP Subscriptions / Recurring Payment Profiles](/imgs/project-n8n-givewp-beacon-integration-workflow/n8n-sync-givewp-beacon-payment-subscription.png)
...
![n8n Sync Beacon - GiveWP: Subscription cancellation branch](/imgs/project-n8n-givewp-beacon-integration-workflow/n8n-sync-givewp-beacon-cancelled-subscription.png)
...
![n8n Sync Beacon - GiveWP: Refund handling branch](/imgs/project-n8n-givewp-beacon-integration-workflow/n8n-sync-givewp-beacon-payment-refund.png)
...
You can [**download the full n8n GiveWP - Beacon Sync workflow** here](https://github.com/amerkay/n8n-workflow-templates-for-charity-non-profit/blob/main/givewp-beacon-crm/Sync-GiveWP-Donations-to-Beacon-CRM-n8n-Workflow.json). Click `Raw` then `Save Page As` and save it as a `.json` file.
